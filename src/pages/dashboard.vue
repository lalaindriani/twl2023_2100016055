<template>
  <div class="font-bold text-4xl py-3 ">Welcome</div>
  <div class="px-5">
    <div>
      <button class="px-4 py-2 border rounded bg-green-500 text-white hover:bg-blue-400 " @click="modelAdd = true">Add New Post </button>
    </div>
    <!-- Show Card Data -->
